{{-- FASE 21.3: Modal to edit patient --}}
...
<div
    ...
    ">
        ...
        <form
            ...
            hx-swap="outerHTML"
            hx-on::after-request="if(event.detail.successful) { document.getElementById('edit-patient-modal').style.display = 'none'; this.reset(); }"
        >
            @csrf
            ...
            <div style="margin-bottom: 1rem;">
                <label for="edit-first-name" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem; color: #374151;">
            ...
            <div style="margin-bottom: 1rem;">
                <label for="edit-last-name" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem; color: #374151;">
            ...
            <div style="margin-bottom: 1.5rem;">
                <label for="edit-dni" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem; color: #374151;">
            ...
            <div style="display: flex; gap: 0.75rem; justify-content: flex-end;">
                <button
                    type="button"
                    onclick="document.getElementById('edit-patient-modal').style.display = 'none'"
                    style="
...
<script>
function openEditPatientModal(id, fullName, dni) {
    ...
    form.setAttribute('hx-patch', `/patients/${id}`);
